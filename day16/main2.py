...
def main():
	...
	while True:
		programs_key = ''.join(programs)
		
		if programs_key in inputs:
			break
		...
		inputs.append(programs_key)
		outputs.append(''.join(programs))
	
	offset = 1000000000 % len(inputs)
	print outputs[offset - 1]
